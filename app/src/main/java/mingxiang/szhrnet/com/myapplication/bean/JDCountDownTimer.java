package mingxiang.szhrnet.com.myapplication.bean;
...
import mingxiang.szhrnet.com.myapplication.myview.MikyouBackgroundSpan;
import mingxiang.szhrnet.com.myapplication.utils.TimerUtils;
   ...
   * */
    ...
    public void initSpanData(String timeStr) {
        ...
        for (int i = 0; i<numbers.length;i++){
            MikyouBackgroundSpan mBackSpan = new MikyouBackgroundSpan(ContextCompat.getDrawable(mContext,mDrawableId), ImageSpan.ALIGN_BOTTOM);
